import argparse
from SerKosach153501.fabric_ser import Fabric
...
if __name__ == "__main__":
    ...
    from_serializer = Fabric.create_serializer(args.format_from)
    to_serializer = Fabric.create_serializer(args.format_to)
